...
export class HomeComponent implements OnInit {
  ...
  ngOnInit() {
    this.seo.generateTags({
      ...
      image: 'img src="https://www.wallpapertip.com/wmimgs/182-1821410_film-wallpaper-square-v2-movie-collection.jpg'
    });
  ...
  trackTab(index: number, item: any): any {
    // since  each tab has a unique identifier we can use as a key (e.g., an id or name)
